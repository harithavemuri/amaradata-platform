(function () {
    ...
    const NAV = [
        ...
        { href: '/billing-contacts', icon: 'contact', label: 'Billing Contacts' },
    ...
    const ICONS = {
        ...
        contact: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 12a4 4 0 10-8 0 4 4 0 008 0zM12 14v7m-4-4l-4 4m16-4l4 4M3 21h18"/>`,
    };
